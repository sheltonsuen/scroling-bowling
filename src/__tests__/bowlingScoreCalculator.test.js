...
test('given 10th round X with following 1st ball 1 balls down and 2nd ball 2 balls down, and previous no balls down when calculate total score then return 13 scores', () => {
    const scoreBoard = [, , , , , , , , , {
        label: 'X',
        firstBallDown: 10,
        secondBallDown: 1,
...
test('given 10th round / with following 1st ball no ball down, current 1st ball and rest no balls down when calculate total score then return 10 scores', () => {
    const scoreBoard = [, , , , , , , , , {
        label: '/',
        firstBallDown: 0,
        secondBallDown: 10,
...
test('given 10th round / with following 1st ball 2 balls down, current 1st ball and rest no balls down when calculate total score then return 12 scores', () => {
    const scoreBoard = [, , , , , , , , , {
        label: '/',
        firstBallDown: 0,
        secondBallDown: 10,
...
test('given 1st round / with following 1st ball no ball down, current 1st ball 1 ball down and rest no balls down when calculate total score then return 10 scores', () => {
    const scoreBoard = [{
        label: '/',
        firstBallDown: 1,
        secondBallDown: 10
